    ...
    fields: `
      <div class="space-y-4">
        <div class="form-group">
          ...
          <input type="text" class="w-full p-2 border rounded-lg" placeholder="1234 5678 9012 3456" maxlength="16" required>
        </div>
        <div class="form-group">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="form-group">
            ...
            <input type="text" class="w-full p-2 border rounded-lg" placeholder="MM/YY" maxlength="5" required>
          </div>
          <div class="form-group">
            <label class="block text-sm font-medium mb-1">CVV</label>
            <input type="password" class="w-full p-2 border rounded-lg" placeholder="***" maxlength="3" required>
          </div>
        </div>
      </div>
    `
    ...
    fields: `
      <div class="space-y-4">
        ...
        <div class="form-group">
          ...
          <input type="text" class="w-full p-2 border rounded-lg" placeholder="username@upi" required>
        </div>
      </div>
    `
  }
...
function processPayment() {
  ...
  setTimeout(() => {
    ...
    document.getElementById('success-message').textContent = 
      `Thank you for choosing our ${selectedPlan.name}. You will receive a confirmation email shortly.`;
