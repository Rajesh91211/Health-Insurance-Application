...
document.getElementById("individual-claim-form").addEventListener("submit", async (event) => {
	handleClaimSubmit(event);
});

document.getElementById("family-claim-form").addEventListener("submit", async (event) => {
	handleClaimSubmit(event);
});
